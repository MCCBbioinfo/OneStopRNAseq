...
params: 
  ...
  metaFile: "input/example_meta.xlsx"
  contrastFile:  "input/example_contrastfile_3.xlsx"
...
-	Normalized expression values, differentially expressed genes, and various types of plots such as DEG heatmaps based on z-score–scaled, variance-stabilized (VST) normalized counts, and volcano plots are in the DESeq2 folder. For example, TPM.xlsx contains normalized expression values.
