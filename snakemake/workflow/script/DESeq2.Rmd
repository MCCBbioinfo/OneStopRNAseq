...
process_deseq_res <- function(res="lfcshrink.res", res2="results.res", name='name', anno='anno.df', norm_exp="tpm.df", nclass=nclass){
    ## Summary
    print(name)
...
for (i in 1:dim(contrast.df)[2]){
  ...
  process_deseq_res(res = res, res2=res2, name = name, anno = anno, norm_exp = normalized_counts, nclass = nclass)
