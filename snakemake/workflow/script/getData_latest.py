...
for srr in srrList:
    ...
    cmd = "cd " + fastq_folder + " && bsub -q long -n 4 -W 40:00 -R rusage[mem=10000] -o " + fastq_folder + "/fastq_dump_" + srr + ".log.txt" + " parallel-fastq-dump -s " + srr + ".sra -t 4 -O ./ --tmpdir ./ --split-3 --skip-technical --gzip"
